...
#'@description
#'
#'This function performs correlation tests for the shocks generated by
#'\code{\link{simshocks}}.
#'
#'@param x gaussian (bivariate) shocks, with correlation, generated by
#'  \code{\link{simshocks}}.
#'
...
#'
#'@return a list with 2 components : estimated correlation coefficients, and
#'  confidence intervals for the estimated correlations.
#'
#'@export
#'
#'@seealso \code{\link{esgplotbands}}
