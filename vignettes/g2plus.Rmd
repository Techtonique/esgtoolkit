...
```{r}
print(dim(difference))
```

**A test of the martingale hypothesis**

```{r cache=TRUE}
lapply(1:nrow(difference), function(i) esgtoolkit::dltest(difference[i, ]))
```

**A 2nd test of the martingale hypothesis**

```{r}
print(str(HDTSA::MartG_test(t(difference))))
```
